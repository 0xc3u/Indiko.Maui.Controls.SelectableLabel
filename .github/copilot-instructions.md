This is a c# (.net9) based repository with a different projects (Maui.net Library, Maui.net App) representing a selectable label for maui.net. 
...
- `Indiko.Maui.Controls.SelectableLabel/`: Maui Library for the Selectable Label Component.
- `Indiko.Maui.Controls.SelectableLabel.Sample/`: Sample Project for displaying the Selectable Label features.
